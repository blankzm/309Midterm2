...
gg3 <- ggplot(covid_vax,
  ...
  ## datese from https://doh.wa.gov/sites/default/files/2022-02/348-862-VaccineTimeline.pdf
  ## vax available:
...
## some theme things - add a black box around plots
...
dash <- (gg2 / (gg1 | gg3)) +
  ...
  plot_annotation(
    ...
    subtitle = 'A dashboard that evaluates the prevalence of COVID in different age groups in Ohio and analyzes COVID rates and vaccination counts\nafter important events such as holidays, new mandates, and vaccination guidelines.',
